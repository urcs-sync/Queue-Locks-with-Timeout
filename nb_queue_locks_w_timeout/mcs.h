...
typedef struct mcs2_try_qnode {
    struct mcs2_try_qnode *volatile prev;
    struct mcs2_try_qnode *volatile next;
    volatile qnode_status status;
} mcs2_try_qnode;
typedef mcs2_try_qnode *volatile mcs2_try_qnode_ptr;
typedef struct {
    mcs2_try_qnode_ptr tail;
    mcs2_try_qnode_ptr lock_holder;     /* node allocated by lock holder */
} mcs2_try_lock;
...
/******** non-blocking timeout, unbounded space: ********/

extern void mcs2_try_init();
extern void mcs2_try_acquire(mcs2_try_lock *L);
extern bool mcs2_try_timed_acquire(mcs2_try_lock *L, hrtime_t T);
extern void mcs2_try_release(mcs2_try_lock *L);
